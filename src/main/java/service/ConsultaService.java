...
public class ConsultaService {
    ...
    public Object addConsulta(Request request, Response response) throws Exception {
        SimpleDateFormat br_format = new SimpleDateFormat("dd/MM/yyyy");

        String titulo = request.queryParams("txt_nome");
        Time time_inicial = request.queryParams("time_inicial");
        Time time_final = request.queryParams("time_final");
        ...
        int Psico_ID = -1;
        int Consulta_ID = ConsultaDAO.getMaxConsultaID + 4;

        Consulta Consulta = new Consulta(Psico_ID, Consulta_ID, titulo, descricao, Criacao, data, time_inicial, time_final);
    ...
    public Object getConsulta(Request request, Response response) {
    ...
    public Object removeConsulta(Request request, Response response) {
        int id = Integer.parseInt(request.params(":Id"));
